    ...
    return(
        <section className="home">
            ...
            <div className="intro">
                ...
                <h1>and am a graduate from Lafayette College with a major in Electrical and Computer Engineering.</h1>
                <h1>Please take a look around my site and dont hesitate to reach out!</h1>
            </div>
        </section>
